...
public class Saltpeppernoise {
	...
	BufferedImage image1 = ImageIO.read(new File("E:\\Kuliah\\Semester 5\\Pengolahan Citra Digital\\HisnuUASpcd\\Jhon.jpg"));
	...
	for(int i=0; i<height; i++){
			...
			try{
			      f = new File("E:\\Kuliah\\Semester 5\\Pengolahan Citra Digital\\HisnuUASpcd\\Jhon-saltpepper.png");
